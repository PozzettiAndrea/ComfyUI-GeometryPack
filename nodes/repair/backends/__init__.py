...
from .pymeshlab_repair import NODE_CLASS_MAPPINGS as MR_PML_MAPS, NODE_DISPLAY_NAME_MAPPINGS as MR_PML_DISP
from .trimesh_repair import NODE_CLASS_MAPPINGS as MR_TM_MAPS, NODE_DISPLAY_NAME_MAPPINGS as MR_TM_DISP
from .pymeshfix_repair import NODE_CLASS_MAPPINGS as MR_PMF_MAPS, NODE_DISPLAY_NAME_MAPPINGS as MR_PMF_DISP
...
NODE_CLASS_MAPPINGS.update(MR_PML_MAPS)
NODE_CLASS_MAPPINGS.update(MR_TM_MAPS)
NODE_CLASS_MAPPINGS.update(MR_PMF_MAPS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(MR_PML_DISP)
NODE_DISPLAY_NAME_MAPPINGS.update(MR_TM_DISP)
NODE_DISPLAY_NAME_MAPPINGS.update(MR_PMF_DISP)
